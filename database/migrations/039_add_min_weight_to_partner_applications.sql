...
-- Migration: 039_add_min_weight_to_partner_applications.sql
-- Description: Adds min_weight column to public.partner_application_services table
--              and updates approve_partner_application RPC to copy min_weight
...
-- 1. Add min_weight column to public.partner_application_services table
ALTER TABLE public.partner_application_services
ADD COLUMN IF NOT EXISTS min_weight NUMERIC(6, 2) NULL;

-- 2. Update approve_partner_application RPC to copy min_weight to public.services
