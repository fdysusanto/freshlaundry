...
-- Migration: 009_fix_approve_partner_application_services_price_mapping.sql
-- Description: Fix approve_partner_application RPC to map partner application services
--              to services.price_per_unit and services.pricing_type instead of non-existent services.price.
