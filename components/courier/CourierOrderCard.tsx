...
import { MapPin, Phone, Clock, ArrowRight, Store, Calendar, UserCheck } from 'lucide-react';
...
export const CourierOrderCard: React.FC<CourierOrderCardProps> = ({
  ...
  return (
    <Card variant="white" className="hover:shadow-lg transition-shadow border-slate-200 space-y-4">
      ...
      {/* Authorized Customer & Route Details (Rendered ONLY after claim confirmation) */}
