  ...
  return (
    <div
      className={`p-5 rounded-3xl border transition-all duration-200 relative ${
        isSelected
          ? 'border-brand-primary bg-brand-surface ring-2 ring-brand-primary/20 shadow-md'
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        ...
        <div className="space-y-2 flex-1">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {service.badge && (
              <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-brand-surface text-brand-primary border border-brand-primary/30">
                {service.badge}
              </span>
            )}
          </div>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
              isSelected
                ...
                : 'bg-slate-100 text-slate-700 hover:bg-brand-surface hover:text-brand-primary'
            }`}
          >
            {isSelected ? (
              <>
      ...
      {isSelected && (
        <div className="mt-4 pt-4 border-t border-brand-primary/20 flex flex-col sm:flex-row items-center justify-between gap-4 bg-white/80 p-4 rounded-2xl border border-brand-primary/10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 bg-slate-100 p-1 rounded-xl border border-slate-200">
              ...
              <span className="w-12 text-center text-xs font-black text-brand-primary">
          ...
          <div className="text-right flex items-center gap-2">
            ...
            <span className="text-sm font-black text-brand-primary bg-brand-surface px-3 py-1 rounded-xl border border-brand-primary/30">
