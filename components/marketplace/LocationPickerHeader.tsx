            ...
            {isLocating ? (
              ...
              <div className="flex items-center gap-1.5 text-slate-700 font-bold text-xs">
                ...
                <button
                  ...
                  className="text-[10px] text-brand-primary hover:text-brand-primary/80 font-bold underline cursor-pointer shrink-0"
                >
                  Ubah
                </button>
              </div>
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-0.5 scrollbar-none text-xs">
            ...
            {quickTags.map((tag) => (
              <button
                ...
                className="px-2.5 py-1 rounded-lg bg-slate-100 hover:bg-brand-surface hover:text-brand-primary border border-slate-200/80 text-[11px] text-slate-600 font-medium transition-all shrink-0 cursor-pointer"
              >
                {tag}
              </button>
            ))}
