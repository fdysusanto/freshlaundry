...
export const LaundryCard: React.FC<LaundryCardProps> = ({ laundry }) => {
  ...
  return (
    <Link href={`/customer/laundries/${laundry.id}`} className="block group">
      <div className="bg-white rounded-3xl border border-slate-200/80 p-5 shadow-xs hover:shadow-xl hover:border-brand-secondary transition-all duration-300 relative flex flex-col justify-between h-full overflow-hidden">
        ...
        <div>
          <div className="flex items-center justify-between gap-2 mb-3">
            <div className="flex items-center gap-2">
              ...
              {laundry.verificationStatus === 'verified' && (
                <span className="inline-flex items-center gap-1 text-[11px] font-bold text-brand-primary bg-brand-surface px-2 py-0.5 rounded-full border border-brand-primary/30">
          ...
          <div className="flex items-start gap-4 mb-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-brand-primary to-brand-secondary text-white font-black text-xl flex items-center justify-center shrink-0 shadow-md shadow-brand-primary/20 group-hover:scale-105 transition-transform">
          ...
          <div className="grid grid-cols-3 gap-2 py-3 px-3.5 bg-slate-50 rounded-2xl border border-slate-100 text-xs font-semibold mb-4">
            ...
            <div className="text-center pl-1">
              <span className="text-brand-primary font-bold">~{laundry.estPickupMinutes} mnt</span>
        ...
        <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
          ...
          <div className="w-9 h-9 rounded-xl bg-brand-surface group-hover:bg-brand-primary text-brand-primary group-hover:text-white flex items-center justify-center transition-all">
