                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-2xl border text-left transition-all cursor-pointer ${
                        isSelected
                          ? 'border-brand-primary bg-white shadow-lg shadow-slate-950/5 ring-2 ring-brand-primary/20'
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {s.badge && (
                          <span className="text-[10px] px-2 py-0.5 rounded-full bg-brand-surface text-brand-primary border border-brand-primary/20 font-bold">
                            {s.badge}
                          </span>
                        )}
                      </div>
            ...
            {activeCatalog && (
              <div className="bg-white p-5 rounded-2xl border border-slate-200 space-y-4 mt-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-base font-black text-brand-primary bg-brand-surface px-3 py-1 rounded-xl border border-brand-primary/20">
              ...
              {activeCatalog ? (
                <div className="space-y-3 text-xs">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-brand-secondary">{activeCatalog.estimatedTime}</span>
                  </div>
                </div>
              ) : (
